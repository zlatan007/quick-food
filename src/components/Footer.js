            ...
            <div className="container-fluid pt-5 bg-footer">
                        ...
                        <div className="col-lg-3 col-md-3 col-sm-12">
                            ...
                            <div className="footer-list-div">
                                <ul>
                                    ...
                                    <li><a href="#">Chole Bhature</a></li>
                                    <li><a href="#">Cheese Burger</a></li>
                                    <li><a href="#">Dal Makhani</a></li>
                                    <li><a href="#">Raj Kachori</a></li>
                                    <li><a href="#">Oreo Shake</a></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div className="container">
                    <div className="col-12 footer-copyright">
                        <p>© 2020 Quick Food. All Rights Reserved. Powered By  <a href="https://github.com/zlatan007"><span style={{ color: "#eb6825", fontWeight: 700 }}>Harshit Shukla</span></a> </p>
                    </div>
                </div>
            </div>
        );
