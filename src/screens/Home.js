      ...
      <div>
        ...
        <div className="container-fluid py-2 bg-warning">
          <div className="row">
            ...
            <div className="col-lg-4 col-md-4 col-sm-12">
              <p className="my-3 text-center text-white"><b className="mr-2 h5">100+</b>People Served</p>
            </div>
            <div className="col-lg-4 col-md-4 col-sm-12">
          ...
          <div className="container">
            <div className="row">
              <div className="col-12 col-lg-4 col-md-4 px-5">
                ...
                <p className="mb-4">Choose from a list of your favorite restaurant and order your favorite food.</p>
              </div>
              <div className="col-12 col-lg-4 col-md-4 px-5">
                <span className="round-border my-4">
                ...
                <p className="mb-4">Our dishes are delicious,cooked with complete hygiene and safety.</p>
              </div>
              <div className="col-12 col-lg-4 col-md-4 px-5">
                <span className="round-border my-4">
                ...
                <p className="mb-4">Place your order and get it delivered hot and fresh with in no time.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container-fluid text-center py-5 home-cont3">
          ...
          <p className="text-white mb-3">Just order your food and get your food hot and fresh with in no time.</p>
                ...
                <div className="container res-shadow res-border">
                  <div className="row p-3">
                    ...
                    <div style={{ position: "relative" }} className="col-lg-8 col-md-8 col-sm-12 py-2">
                      ...
                      <p className="mb-2"><small>Apple Juice, Masala Dosa, Cheese Burger</small></p>
                      <p>
                        <small className="">
                ...
                <div className="container res-shadow res-border">
                  <div className="row p-3">
                    ...
                    <div style={{ position: "relative" }} className="col-lg-8 col-md-8 col-sm-12 py-2">
                      ...
                      <p className="mb-2"><small>Oreo Shake, Vegetable Soup, Cold Coffee</small></p>
                      <p>
                        <small className="">
                          <FontAwesomeIcon icon="star" className="rating mr-1" />
                          <FontAwesomeIcon icon="star" className="rating mr-1" />
                ...
                <div className="container res-shadow res-border">
                  <div className="row p-3">
                    ...
                    <div style={{ position: "relative" }} className="col-lg-8 col-md-8 col-sm-12 py-2">
                      ...
                      <p className="mb-2"><small>Fish Fry, Fruit Juice, Raj Kachori</small></p>
                      <p>
                        <small className="">
                          <FontAwesomeIcon icon="star" className="rating mr-1" />
                          <FontAwesomeIcon icon="star" className="rating mr-1" />
                ...
                <div className="container res-shadow res-border">
                  <div className="row p-3">
                    ...
                    <div style={{ position: "relative" }} className="col-lg-8 col-md-8 col-sm-12 py-2">
                      ...
                      <p className="mb-2"><small>Dal Makhani, Cheese Burger, Doughnut</small></p>
                      <p>
                        <small className="">
                          <FontAwesomeIcon icon="star" className="rating mr-1" />
                          <FontAwesomeIcon icon="star" className="rating mr-1" />
                ...
                <div className="container res-shadow res-border">
                  <div className="row p-3">
                    ...
                    <div style={{ position: "relative" }} className="col-lg-8 col-md-8 col-sm-12 py-2">
                      ...
                      <p className="mb-2"><small>Pizza, Burger, Oreo Shake</small></p>
                      <p>
                        <small className="">
                          <FontAwesomeIcon icon="star" className="rating mr-1" />
                          <FontAwesomeIcon icon="star" className="rating mr-1" />
